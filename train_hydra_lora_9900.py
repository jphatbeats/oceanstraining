"""
HYDRA LoRA Training - FULL 9900 STEPS
...
print("=" * 70)
print("HYDRA LORA TRAINING - FULL 9900 STEPS")
print("=" * 70)
...
# Paths
BASE_MODEL = "N:/OCEANS/oceans_training/merged_superbase/hydra"  # Local merged Qwen3 model
CORPUS_FILE = "N:/OCEANS/oceans_training/data/super_mix/HYDRA_super_mix.jsonl"
OUTPUT_DIR = "N:/OCEANS/oceans_training/outputs_hydra_lora_9900"
...
# Train!
print("\n" + "=" * 70)
print("STARTING HYDRA LORA TRAINING - 9900 STEPS")
print("=" * 70)
