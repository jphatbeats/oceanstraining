"""
ARIA LoRA Training - FULL 9900 STEPS
Trains LoRA adapter on AdaptLLM/finance-chat base model
Fast LoRA training: ~2.5 sec/step = ~6.9 hours total
"""

import os
os.environ['CUDA_VISIBLE_DEVICES'] = '0'  # Force GPU 0 (RTX 5090)
...
print("=" * 70)
print("ARIA LORA TRAINING - FULL 9900 STEPS")
print("=" * 70)
...
# Paths
BASE_MODEL = "N:/OCEANS/oceans_training/merged_superbase/aria"  # Local merged Qwen3 model
CORPUS_FILE = "N:/OCEANS/oceans_training/data/super_mix/ARIA_super_mix.jsonl"
OUTPUT_DIR = "N:/OCEANS/oceans_training/outputs_aria_lora_9900"
...
training_args = TrainingArguments(
    ...
    max_steps=9900,                         # COMBINED TRAINING
...
# Train!
print("\n" + "=" * 70)
print("STARTING ARIA LORA TRAINING - 9900 STEPS")
print("=" * 70)
