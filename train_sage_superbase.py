"""
SAGE Super-Base Training (Phase 2)
...
# Configuration
MERGED_MODEL_PATH = "N:/OCEANS/oceans_training/merged_superbase/sage"
OUTPUT_DIR = "N:/OCEANS/oceans_training/outputs_sage_superbase"
...
print("=" * 70, flush=True)
print("SAGE SUPER-BASE TRAINING (PHASE 2)", flush=True)
print("=" * 70, flush=True)
...
# Train
print("\n" + "=" * 70, flush=True)
print("STARTING SAGE SUPER-BASE TRAINING", flush=True)
print("=" * 70, flush=True)
...
try:
    ...
    print("\nSUCCESS: SAGE super-base training complete!", flush=True)
