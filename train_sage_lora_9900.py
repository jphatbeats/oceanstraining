"""
SAGE LoRA Training - FULL 9900 STEPS
Trains LoRA adapter on Qwen2-7B-Instruct base model
...
print("=" * 70)
print("SAGE LORA TRAINING - FULL 9900 STEPS")
print("=" * 70)
...
# Paths
BASE_MODEL = "N:/OCEANS/oceans_training/merged_superbase/sage"  # Local merged Qwen3 model
CORPUS_FILE = "N:/OCEANS/oceans_training/data/super_mix/SAGE_super_mix.jsonl"
OUTPUT_DIR = "N:/OCEANS/oceans_training/outputs_sage_lora_9900"
...
# Train!
print("\n" + "=" * 70)
print("STARTING SAGE LORA TRAINING - 9900 STEPS")
print("=" * 70)
