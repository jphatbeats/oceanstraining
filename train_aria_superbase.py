"""
ARIA Super-Base Training (Phase 2)
Trains merged super-base model (finance-chat + Phase 1 LoRA) for 9000 steps
"""
...
# Configuration
MERGED_MODEL_PATH = "N:/OCEANS/oceans_training/merged_superbase/aria"
OUTPUT_DIR = "N:/OCEANS/oceans_training/outputs_aria_superbase"
...
print("=" * 70, flush=True)
print("ARIA SUPER-BASE TRAINING (PHASE 2)", flush=True)
print("=" * 70, flush=True)
...
# Train
print("\n" + "=" * 70, flush=True)
print("STARTING ARIA SUPER-BASE TRAINING", flush=True)
print("=" * 70, flush=True)
...
try:
    ...
    print("\nSUCCESS: ARIA super-base training complete!", flush=True)
