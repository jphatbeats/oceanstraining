"""
ARIA TRAINING SCRIPT - RUNPOD 4xA6000
======================================
Trains ARIA entity on Qwen3-30B base with 4-bit QLoRA.

Dataset: ARIA_final_training.jsonl (197,479 samples)
  - Ocean Scanner intelligence (30%)
  - News & narratives (20%)
  - Episodes & system knowledge (20%)
  - **DONOR MODELS (10,264 samples):**
    - FinBERT sentiment (2,264 samples)
    - CryptoBERT social (13,000 samples subsampled)
    - FinRL reinforcement traces (15,000 samples subsampled)

Base Model: Qwen/Qwen3-30B-A3B-Instruct-2507
Hardware: 4xA6000 192GB VRAM (distributed automatically)
Training Time: ~6.9 hours
Output: aria_adapter.safetensors (~50-60MB)

Usage:
    python train_aria_4xA6000.py
"""
...
DATASET_PATH = "/workspace/datasets/ARIA_final_training.jsonl"
OUTPUT_DIR = "/workspace/output/aria_adapter"
...
def main():
    ...
    logger.info(f"  ✓ Includes 10,264 donor model samples (FinBERT, CryptoBERT, FinRL)")
    ...
    logger.info("\nNext: Download these files and deploy to local ARIA server!")
    logger.info("\nDONE! 🌊⚡")
