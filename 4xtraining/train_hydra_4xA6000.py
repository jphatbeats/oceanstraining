"""
HYDRA TRAINING SCRIPT - RUNPOD 4xA6000
=======================================
Trains HYDRA entity on Qwen3-30B base with 4-bit QLoRA.

Dataset: HYDRA_final_training.jsonl (201,215 samples)
  - Social intelligence (LunarCrush)
  - Multi-persona reasoning (3 heads)
  - Episodes & system knowledge (20%)
  - **DONOR MODELS (14,000 samples):**
    - FinBERT sentiment (2,264 samples)
    - CryptoBERT social (13,000 samples)
...
Output: hydra_adapter.safetensors (~50-60MB)

Usage:
    python train_hydra_4xA6000.py
"""
...
DATASET_PATH = "/workspace/datasets/HYDRA_final_training.jsonl"
OUTPUT_DIR = "/workspace/output/hydra_adapter"
...
def main():
    ...
    logger.info(f"  ✓ Includes 14,000 donor model samples (FinBERT, CryptoBERT, FinRL)")
    ...
    logger.info("\nNext: Download these files and deploy to local HYDRA server!")
    logger.info("\nDONE! 🌊⚡")
