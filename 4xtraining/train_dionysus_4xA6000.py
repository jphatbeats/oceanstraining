"""
DIONYSUS TRAINING SCRIPT - RUNPOD 4xA6000
==========================================
Trains DIONYSUS entity on Qwen3-30B base with 4-bit QLoRA.

Dataset: DIONYSUS_final_training.jsonl (201,215 samples)
  - Meme intelligence (30%)
  - Social signals & GoPlus security (20%)
  - Episodes & persona knowledge (20%)
...
Usage:
    python train_dionysus_4xA6000.py
"""
