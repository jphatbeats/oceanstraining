"""
DIONYSUS TRADING BRAIN TRAINING SCRIPT - RUNPOD A6000
======================================================
Trains DIONYSUS trading brain on phi3:mini with 4-bit QLoRA.

Dataset: DIONYSUS_trading_brain_ENHANCED.jsonl (28,094 samples)
Base Model: microsoft/Phi-3-mini-4k-instruct
Hardware: A6000 48GB VRAM
Training Time: ~2-3 hours
Output: dionysus_trading_adapter.safetensors (~20-30MB)

Usage:
    python train_dionysus_trading_runpod.py
"""
...
TRAINING_CONFIG = {
    "num_train_epochs": 1,
    "max_steps": 2500,  # Smaller dataset = fewer steps
...
# LoRA configuration (optimized for phi3:mini)
LORA_CONFIG = {
    "r": 16,
    "lora_alpha": 32,
...
def main():
    ...
    logger.info("\nNext: Download these files and deploy to local DIONYSUS trading brain!")
