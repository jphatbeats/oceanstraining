"""
HYDRA Super-Base Training (Phase 2)
Trains merged super-base model (Qwen2-7B + Phase 1 LoRA) for 9000 steps
"""
...
# Configuration
MERGED_MODEL_PATH = "N:/OCEANS/oceans_training/merged_superbase/hydra"
OUTPUT_DIR = "N:/OCEANS/oceans_training/outputs_hydra_superbase"
DATASET_PATH = "N:/OCEANS/oceans_training/datasets/ocean_intelligence_corpus/training_corpus.jsonl"
...
print("=" * 70, flush=True)
print("HYDRA SUPER-BASE TRAINING (PHASE 2)", flush=True)
print("=" * 70, flush=True)
...
# Train
print("\n" + "=" * 70, flush=True)
print("STARTING HYDRA SUPER-BASE TRAINING", flush=True)
print("=" * 70, flush=True)
...
try:
    ...
    print("\nSUCCESS: HYDRA super-base training complete!", flush=True)
